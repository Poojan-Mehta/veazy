!function (a, b) {
    b["true"] = a, angular.module("textAngularSetup", []).value("taOptions", {
        toolbar: [["bold", "italics", "underline", "ul", "ol", "redo", "undo", "justifyLeft", "justifyCenter", "justifyRight", "indent", "outdent"]],
        classes: {
            focussed: "focussed",
            toolbar: "btn-toolbar",
        ...
        renderLogic: function (a) {
            ...
            if(a[0].className == 'ta-insert-video'){
                angular.forEach(c, function (a) {
                    b.attr(a.name, a.value)
                }), b.attr("src", b.attr("src")), a.replaceWith(b)
            }
        }
        ...
        a("insertImage", {
            ...
            iconclass: "fa fa-youtube-play", tooltiptext: c.insertVideo.tooltip, action: function () {
                ...
                if (a = b.prompt(c.insertVideo.dialogPrompt, "http://"), a && "" !== a && "http://" !== a) {
                    var d = a.match(/(\?|&)v=[^&]*/);
                    if (d.length > 0) {
                        var e = "http://www.youtube.com/embed/" + d[0].substring(3), f = '<img class="ta-insert-video" ta-insert-video="' + e + '" contenteditable="false" src="' + e + '" allowfullscreen="true" width="300" frameborder="0" height="250"/>';
