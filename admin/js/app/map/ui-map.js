      ...
      return {
        ...
        //  var map = '';
         ...
         window.setTimeout(function(){
            ...
            // map.setCenter(scope.marker.getPosition());
          },100);

            google.maps.event.addListener(map, 'resize', function() {
                var markerd = new google.maps.LatLng(34.7857324,134.3756902);
                map.setCenter(markerd);
            });
          ...
          var lng = parseFloat(scope.lng);
            ...
            if(scope.lat != '' && scope.lng != ''){
                ...
                google.maps.event.addListener(scope.marker, "dragend", function (event) {
                    ...
                    scope.gpslocation.latlng = event.latLng.lat()+','+event.latLng.lng();
                }); //end addListene
