'use strict';
/* Controllers */
app.controller('summarycategorylistCtrl', ['$scope', '$window', '$http', '$rootScope', '$timeout', '$filter', '$stateParams', '$state','toaster','prompt',
    function ($scope, $window, $http, $rootScope, $timeout, $filter, $stateParams, $state,toaster,prompt) {
        ...
        /** GET SUMMARY CATEGORY DETAILS BY TYPE*/
        function getData() {
            var paramd = {
                type:$scope.type
            };
        ...
        /** GET SUMMARY CATEGORY DETAILS IN ORDER TO CHANGE FOLDER*/
        ...
        /** CHANGE STATUS OF SUMMARY CATEGORY*/
        ...
        /** REMOVE ALL SELECTED SUMMARY CATEGORY*/
        ...
        /** ACTIVE ALL SELECTED SUMMARY CATEGORY*/
        ...
        /** DEACTIVE ALL SELECTED SUMMARY CATEGORY */
