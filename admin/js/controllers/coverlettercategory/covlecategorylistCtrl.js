'use strict';
/* Controllers */
app.controller('covercategorylistCtrl', ['$scope', '$window', '$http', '$rootScope', '$timeout', '$filter', '$stateParams', '$state','toaster','prompt',
    function ($scope, $window, $http, $rootScope, $timeout, $filter, $stateParams, $state,toaster,prompt) {
        $scope.id = localStorage.getItem('aid');
        $scope.rowCollection = [];
        $scope.type = "cover";

        /** GET COVERLETTER DATA BY TYPE*/
        function getData() {
            var paramd = {
                eType:$scope.type
            };
        ...
        /** CHANGE COVERLETTER CATEGORY STATUS*/
        ...
        /** REMOVE SELECTED COVERLETTER CATEGORY*/
        ...
        /** ACTIVE SELECTED COVERLETTER CATEGORY*/
        ...
        /** INACTIVE SELECTED COVERLETTER CATEGORY */
